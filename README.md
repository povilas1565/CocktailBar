...
### Итог
Получившееся приложение находится в билд-формате .aab(пакет установки в Google Play) в директории app/release/app-release.aab, даное приложение готово к выгрузки в стор. Скрины находятся в директории presentation.
 Все задания были выполнены безукоризненно. Спасибо большое организаторам Surf Study Jam в направлении Android. Вы классные и суперские!!!🤩💋❤️😱😇
P.S. Я жажду попасть к Вам уже больше 2-х лет на позицию джуна!!! Надесюсь, получится таки наконец. Мне Android больше всего импонирует, да и опыта без малого 4 года именно на Android.
