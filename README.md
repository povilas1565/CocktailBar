...
### Итог
Получившееся приложение находится в билд-формате .aab(пакет установки в Google Play) в директории app/release/app-release.aab, даное приложение готово к выгрузки в стор. 
